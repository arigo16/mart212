...
$grandtotal_harga_jual = $_POST['grandtotal_harga_beli'];
...
if ($grandtotal_harga_beli == "") {
	...
	if ($con->affected_rows > 0){
		echo "<script>alert('Data barang masuk telah berhasil disimpan');window.location='../index.php?page=barang-masuk'</script>";
	}else{
